...
class DeepDream:
    ...
    def get_tile_size(self,num_pixels, tile_size=400):
        """
    ...
    def tiled_gradient(self,gradient, image, tile_size=400):
        ...
        x_tile_size = self.get_tile_size(num_pixels=x_max, tile_size=tile_size)
        # 1/4 of the tile-size.
        x_tile_size4 = x_tile_size // 4

        # Tile-size for the y-axis.
        y_tile_size = self.get_tile_size(num_pixels=y_max, tile_size=tile_size)
        # 1/4 of the tile-size
    ...
    def optimize_image(self,layer_tensor, image,
        ...
        gradient = self.model.get_gradient(layer_tensor)
    ...
    def recursive_optimize(self,layer_tensor, image,
        ...
        if num_repeats>0:
            ...
            # Downscale the image.
            img_downscaled = h.resize_image(image=img_blur,
                                        factor=rescale_factor)
                
            # Recursive call to this function.
            # Subtract one from num_repeats and use the downscaled image.
            img_result = self.recursive_optimize(layer_tensor=layer_tensor,
            ...
            img_upscaled = h.resize_image(image=img_result, size=image.shape)
        ...
        img_result = self.optimize_image(layer_tensor=layer_tensor,
                                    image=image,
                                    num_iterations=num_iterations,
                                    step_size=step_size,
                                    tile_size=tile_size)
